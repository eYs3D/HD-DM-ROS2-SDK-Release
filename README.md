...
* Tested on X86 PC with Ubuntu 22.04
* Support ARM aarch64  (64-bit)
* Tested on ARM64 NVIDIA Jetson devices with Ubuntu 22.04
* These are the currently supported ROS2 Distributions:
  - Humble Hawksbill (Ubuntu 22.04 Jammy)
...
## Installation ROS2 HUMBLE Instructions

The following instructions are written for ROS2 Humble on Ubuntu 22.04
 ...
 - Set locale
  ...
  - Check environment variables
    ...
    printenv | grep -i ROS
    ```
    Check that variables like ROS_DISTRO and ROS_VERSION are set. For example, if you're using Humble, you would see:
    ```
    ROS_VERSION=2
...
## Build eYs3D ROS2
 ...
 - Clone the repository
   ```
   git clone https://github.com/eYs3D/HD-DM-ROS2-SDK-Release.git
